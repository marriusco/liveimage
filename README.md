...
### Tested
  ...
  * R-PI 3 and some noname usb camera, onboard wifi.
  * Nano PI Neo, with noname camera solderred on the USB2 pins, and wifi dongle solderred on USB1 on the pins
  * C. H. I. P, with noname web cam, onboard wifi'es, one as AP one as client to my Net
